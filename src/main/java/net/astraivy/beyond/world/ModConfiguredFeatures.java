package net.astraivy.beyond.world;
...
public class ModConfiguredFeatures {
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> context) {
        register(context, CELESTIAL_TREE_KEY, Feature.TREE, new TreeFeatureConfig.Builder(
                BlockStateProvider.of(ModBlocks.CELESTIAL_LOG.getDefaultState()),
                new StraightTrunkPlacer(5, 6, 3),

                BlockStateProvider.of(ModBlocks.CELESTIAL_LEAVES.getDefaultState()),
